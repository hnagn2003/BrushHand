...
```
## Infer 2D mesh and 3D .obj hand
Remember to update the absolute data path in the inference code
```bash
python3 gen_mesh.py --data_type COCO --batch_size 32
...
Remember to update the absolute data path in the inference code
```bash
python3 gen3dparams.py --data_type COCO --batch_size 32
